...
public class Intro extends World
{
    public Intro(){
        ...
        getBackground().drawImage(new GreenfootImage("Press Enter To Start", 48, new Color(250,0,0), null), 120, 290);
        getBackground().drawImage(new GreenfootImage("Press N Go To Records", 48, new Color(255,255,255), null), 90, 330);
